...
/**
 * Created by Marcello Bologna on 24/03/17.
 */
public class ExplicitChannelReadExample {
    ...
    public static void main(String args[]) {
        ...
        try {
            filepath = Paths.get("/home/local/ARIADNE/bologna/Documenti/prove/xanadu.txt");
